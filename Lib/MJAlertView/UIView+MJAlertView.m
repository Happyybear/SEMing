...
#define UIColorFromRGB(rgbValue) [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/101.0 green:((float)((rgbValue & 0xFF00) >> 8))/192.0 blue:((float)(rgbValue & 0xFF))/239.0 alpha:1.0]
...
static const CGFloat kHeightFromBottom = 220.f;
    ...
    if(notifierView) {
        ...
        [self updateNotifierWithAnimation:notifierView withText:text completion:^(BOOL finished) {
            ...
            if(!shouldDismiss) {
                ...
                [separatorImageView setBackgroundColor:UIColorFromRGB(0xff7f00)];
                ...
                [buttonCancel setTitle:@"确定" forState:UIControlStateNormal];
        ...
        notifierView.backgroundColor = UIColorFromRGB(0xff7f00);
